...
## Overview
This project focuses on enhancing segmented product images extracted from YouTube video frames.  
The goal is to generate 2–3 high-quality, studio-style product shots with professional backgrounds using AI-based image-to-image generation.

Initially, Gemini Nano and Gemini Flash were tested for image enhancement, but they did not support image generation.  
Therefore, **Stability AI’s Stable Diffusion XL (SDXL)** model was used to achieve stable and high-quality results.
...
### 3. Enhancement
- Enhanced each segmented product using **Stability AI’s SDXL model**.  
...
- Attempting to use it caused errors such as:
